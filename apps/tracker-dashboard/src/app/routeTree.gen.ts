...
const appAppProjectEnrollmentIndexRoute = appAppProjectEnrollmentIndexRouteImport.update({
  id: '/',
  path: '/',
  getParentRoute: () => appAppProjectEnrollmentRoute,
} as any);
const appAppProjectEnrollmentRoundIdRoute = appAppProjectEnrollmentRoundIdRouteImport.update({
  id: '/$roundId',
  path: '/$roundId',
  getParentRoute: () => appAppProjectEnrollmentRoute,
} as any);
...
export interface FileRouteTypes {
  ...
  to: '/schedule' | '/login' | '/' | '/defense/$roundId' | '/project-enrollment/$roundId' | '/project-enrollment';
  id:
    | '__root__'
    | '/(app)/_app'
    | '/(auth)/_auth'
...
const appAppProjectEnrollmentRouteWithChildren = appAppProjectEnrollmentRoute._addFileChildren(
