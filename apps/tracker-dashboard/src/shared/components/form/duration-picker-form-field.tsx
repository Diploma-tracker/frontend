...
} from '@repo/ui-kit/components/common/form/duration-picker';
import {
  Field,
  FieldDescription,
  FieldError,
...
interface DurationPickerFormFieldProps extends Omit<
  DurationPickerProps,
...
export const DurationPickerFormField = reatomComponent(
  function DurationPickerFormField({
    field,
    label,
    description,
    ...pickerProps
