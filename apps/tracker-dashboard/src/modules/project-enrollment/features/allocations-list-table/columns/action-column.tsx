...
import {
  closeAllocationRoundAction,
  openAllocationRoundAction,
} from '../../../models/allocation-round-actions-model';

export const ActionColumn: ColumnDef<AllocationRoundDTO> = {
  id: 'actions',
  header: () => (
    <T k="projectEnrollment.allocationRound.table.columns.actions" />
  ),
  cell: actionCell<AllocationRoundDTO>([
    {
      ...
      modal: {
        title: (
          <T k="projectEnrollment.allocationRound.actions.confirmOpen.title" />
        ),
        description: (
          <T k="projectEnrollment.allocationRound.actions.confirmOpen.description" />
        ),
      },
    },
    {
      ...
      modal: {
        title: (
          <T k="projectEnrollment.allocationRound.actions.confirmClose.title" />
        ),
        description: (
          <T k="projectEnrollment.allocationRound.actions.confirmClose.description" />
        ),
      },
    },
    {
