...
export const RoundDefenseSchedulePage = reatomComponent(
  function RoundDefenseSchedulePage({
    roundId,
        ...
        <Guard can={permissions.isAdmin}>
          ...
          <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>
                  {t('defense.session.dialog.createTitle')}
                </DialogTitle>
                <DialogDescription>
                  {t('defense.session.dialog.createDescription')}
                </DialogDescription>
              </DialogHeader>
              <CreateDefenseSessionForm
                roundId={roundId}
