  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        months: cn('ui:flex ui:gap-4 ui:flex-col ui:md:flex-row ui:relative', defaultClassNames.months),
        ...
        dropdown: cn('ui:absolute ui:bg-popover ui:inset-0 ui:opacity-0', defaultClassNames.dropdown),
        caption_label: cn(
        ...
        week_number_header: cn('ui:select-none ui:w-(--cell-size)', defaultClassNames.week_number_header),
        week_number: cn('ui:text-[0.8rem] ui:select-none ui:text-muted-foreground', defaultClassNames.week_number),
        day: cn(
        ...
        outside: cn('ui:text-muted-foreground ui:aria-selected:text-muted-foreground', defaultClassNames.outside),
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }: ChevronProps) => {
          if (orientation === 'left') {
            return <CaretLeftIcon className={cn('ui:size-4', className)} {...props} />;
          }

          if (orientation === 'right') {
            return <CaretRightIcon className={cn('ui:size-4', className)} {...props} />;
          }

          return <CaretDownIcon className={cn('ui:size-4', className)} {...props} />;
        },
