...
const fieldVariants = cva('ui:group/field ui:flex ui:w-full ui:gap-3 ui:data-[invalid=true]:text-destructive', {
  variants: {
    orientation: {
...
function FieldContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('ui:group/field-content ui:flex ui:flex-1 ui:flex-col ui:gap-1.5 ui:leading-snug', className)}
      {...props}
    />
  );
}
