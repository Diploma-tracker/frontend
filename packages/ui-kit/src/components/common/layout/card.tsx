...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-title" className={cn('ui:leading-none ui:font-semibold', className)} {...props} />;
}

function CardDescription({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot="card-description" className={cn('ui:text-sm ui:text-muted-foreground', className)} {...props} />
  );
}
...
function CardAction({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('ui:col-start-2 ui:row-span-2 ui:row-start-1 ui:self-start ui:justify-self-end', className)}
      {...props}
    />
  );
}
